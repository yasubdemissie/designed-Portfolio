...
export function Header() {
  ...
  return (
    <header className="fixed top-1 left-0 right-0 w-full mx-4 sm:w-5/6 md:w-4/5 lg:w-2/3 rounded-2xl sm:rounded-3xl lg:rounded-4xl sm:mx-auto bg-brand-second z-50">
